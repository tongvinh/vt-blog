...
{
    public class SeriesRepository(VTBlogContext context, IMapper mapper) : RepositoryBase<Series, Guid>(context), ISeriesRepository
    {
        ...
        {
            var postInSeries =
                await _context.PostInSeries.FirstOrDefaultAsync(x => x.PostId == postId & x.SeriesId == seriesId);
