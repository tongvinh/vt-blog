...
namespace VTBlog.Api.Controllers.AdminApi
{
    ...
    public class UserController(UserManager<AppUser> userManager, IMapper mapper, IUnitOfWork unitOfWork) : ControllerBase
    {
        ...
        [HttpGet("paging")]
        [Authorize(Users.View)]
        public async Task<ActionResult<PagedResult<UserDto>>> GetAllUsersPaging(string? keyword, int pageIndex,
            int pageSize)
        {
