...
export class RoyaltyMonthComponent implements OnInit, OnDestroy {
  ...
  loadData() {
    ...
    this.RoyaltyApiClient.getRoyaltyReportByMonth(this.userName, this.fromMonth, this.fromYear, this.toMonth, this.toYear).pipe(takeUntil(this.ngUnsubscribe)).subscribe({
