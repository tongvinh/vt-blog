...
export class RoyaltyUserComponent implements OnInit, OnDestroy {
  ...
  loadData() {
    ...
    this.RoyaltyApiClient.getRoyaltyReportByUser(this.userName, this.fromMonth, this.fromYear, this.toMonth, this.toYear).pipe(takeUntil(this.ngUnsubscribe)).subscribe({
